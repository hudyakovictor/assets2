// Casual AAA Mobile Game Vector Icon Suite (Pure SVG, NO EMOJI)
...
export function IconCoin({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 28 28" fill="none" className={className}>
      ...
      {/* Crypto / Coin Emblem - stylized Bitcoin/Signal B */}
      <path
...
// DUAL SWORDS HERO BADGE (for duel button & arena logo)
...
// SKILL ICONS (In circular medallions like the reference screenshots)
...
export function IconVolumeBars({ className = "w-7 h-7" }: { className?: string }) {
  return (
    <svg viewBox="0 0 28 28" fill="none" className={className}>
      {/* 3 distinct colored volume bars like reference: green, yellow, red */}
...
// TOURNAMENT TROPHY & PODIUM ICONS
...
// AVATARS FOR LEADERBOARD (Doge / Knight / Whale / Queen) - pure vector, no emoji!
